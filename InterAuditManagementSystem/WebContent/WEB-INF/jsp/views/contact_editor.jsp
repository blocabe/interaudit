...
<head>
	...
	<title>Edit contact  ${contact.firstName} &nbsp;${contact.lastName}</title>
...
<script>
 ...
 function previewInvoice(id)
  ...
  function editContact() {
	...
	var url ="${ctx}/editContactPage.htm?contactId=";
...
<div class="nav_alphabet" style="background-color: rgb(248, 246, 233); border: 1px solid  #0066aa; text-align:center; padding-top:1pt; font: bold 12px Verdana, sans-serif;">
		<form name="listForm" action="" method="post" >                 
		                ...
		                <select style="font:10px Verdana, sans-serif;margin-right:10pt;" name="id" id="id" onchange="editContact();">                  
...
<div id="global">
	...
	<tr>
      ...
      <td>
        <span  style="color:blue;font-weight: bold;">${contact.lastName}</span>
      </td>
    </tr>
	...
	<tr>
      ...
      <td>
		<span  style="color:blue;font-weight: bold;">${contact.firstName}</span>
      </td>
    </tr>
	...
	<tr>
      <th>Sex</th>
      <td>
	  <span  style="color:black;font-weight: bold;">${contact.sex}</span>
	...
	<tr>
	  ...
	  <span  style="color:black;font-weight: bold;">
	   ...
	   <c:choose>
            <c:when test='${contact.company != null }'>                                                  
                ${contact.company}
            </c:when>
            <c:when test='${contact.company == null }'>                                                  
                ---
	...
	<tr>
	  ...
	  <span  style="color:black;font-weight: bold;">
	   ...
	   <c:choose>
            <c:when test='${contact.mainActivity != null }'>                                                  
	...
	<tr>
      ...
      <td>	  	
		<div id="editable_cont">
			<div id="addresse" class="editable">${contact.customer.mainAddress}</div>			
		</div>
	...
	<tr>
	  ...
	  <span  style="color:black;font-weight: bold;">
	   ...
	   <c:choose>
            <c:when test='${contact.jobTitle != null }'>                                                  
                ${contact.jobTitle}
            </c:when>
            <c:when test='${contact.jobTitle == null }'>                                                  
                ---
	...
	<tr>
	  ...
	  <span  style="color:black;font-weight: bold;">
	  <c:choose>
            <c:when test='${contact.businessPhone != null }'>                                                  
	...
	<tr>
	  ...
	  <span  style="color:black;font-weight: bold;">
	  <c:choose>
            <c:when test='${contact.businessMobile != null }'>                                                  
	...
	<tr>
	  ...
	  <span  style="color:black;font-weight: bold;">
	  <c:choose>
            <c:when test='${contact.personalPhone != null }'>                                                  
	...
	<tr>
	  ...
	  <span  style="color:black;font-weight: bold;">
	  <c:choose>
            <c:when test='${contact.personalMobile != null }'>                                                  
	...
	<tr>
	  ...
	  <span  style="color:black;font-weight: bold;">
	  <c:choose>
            <c:when test='${contact.businessFax != null }'>                                                  
                ${contact.businessFax}
            </c:when>
            <c:when test='${contact.businessFax == null }'>                                                  
                ---
	...
	<tr>
	  ...
	  <span  style="color:black;font-weight: bold;">
	  <c:choose>
            <c:when test='${contact.email != null }'>                                                  
                ${contact.email}
            </c:when>
            <c:when test='${contact.email == null }'>                                                  
                ---
	...
	<tr>
	  ...
	  <span  style="color:black;font-weight: bold;">
	  <c:choose>
            <c:when test='${contact.companyContactMail != null }'>                                                  
                ${contact.companyContactMail}
            </c:when>
            <c:when test='${contact.companyContactMail == null }'>                                                  
                ---
            </c:when>                                           
	...
	<tr>
	  ...
	  <span  style="color:black;font-weight: bold;">
	  <c:choose>
            <c:when test='${contact.companyWebAddr != null }'>                                                  
                ${contact.companyWebAddr}
            </c:when>
            <c:when test='${contact.companyWebAddr == null }'>                                                  
                ---
            </c:when>                                           
