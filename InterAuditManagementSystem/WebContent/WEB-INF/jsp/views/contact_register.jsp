...
<!-- START OF CONTENTS PARTstyle="background-color: rgb(248, 246, 233);"--> 
 <div style="font-size: .7em;background-color: #F8F6E9;">
	<br/>
	<jsp:include page="contact_register-content.jsp"/>
	<br/>
</div>
...
<c:forEach var="customer" items="${allCustomersNames}" varStatus="loop">
	statesArray[${loop.index}] = '${customer.name}';
</c:forEach>
