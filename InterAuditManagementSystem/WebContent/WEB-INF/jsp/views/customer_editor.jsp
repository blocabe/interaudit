...
<head>
	...
	<title>Edit customer  ${customer.companyName} </title>
	...
	function showInvoiceInfos(id){
	  ...
	  function addPayment()
		...
		function editCustomer() {
		    ...
		    var url ="${ctx}/editCustomerPage.htm?customerId=";
...
<div class="nav_alphabet" style="background-color: rgb(248, 246, 233); border: 1px solid  #0066aa; text-align:center; padding-top:1pt; font: bold 12px Verdana, sans-serif;">
        <form name="listForm" action="" method="post" >                 
                        ...
                        <select style="font:10px Verdana, sans-serif;margin-right:10pt;" name="id" id="id" onchange="editCustomer();">                  
...
<div id="global">
	...
	<tr>
      ...
      <td>
        <span  style="color:blue;font-weight: bold;">${customer.code}</span>
      </td>
    </tr>
	...
	<tr>
      ...
      <td>
	   <c:choose>
			...
			<c:when test='${customer.active eq true }'>
			 <span style="color:green;font-weight: bold;">Actif</span>
			</c:when>

			<c:when test='${customer.active eq false }'>
	...
	<tr>
      <th>Nom</th>
      <td>
	  <span  style="color:black;font-weight: bold;">${customer.companyName}</span>
	...
	<tr>
	  ...
	  <span  style="color:black;font-weight: bold;">	
	   <c:choose>
			...
			<c:when test='${customer.fax eq null }'>
			 <span style="color:green;font-weight: bold;">--</span>
			</c:when>

			<c:when test='${customer.active != null }'>
			 <span style="color:red;font-weight: bold;"> ${customer.fax}</span>
			</c:when>												
		</c:choose>  
	...
	<tr>
      ...
      <td>	  	
		<div id="editable_cont">
			<div id="addresse" class="editable">${customer.mainAddress}</div>			
		</div>
	...
	<tr>
      ...
      <td>	  	
		<div id="editable_cont">
			<div id="addresse" class="editable">${customer.mainBillingAddress}</div>			
		</div>
	...
	<tr>
      <th>Origine</th>
      <td>        
       <span  style="color:black;font-weight: bold;">${customer.origin.name}</span>
      </td>
    </tr>
	...
	<tr>
      <th>Associé</th>
      <td>
        <span  style="color:black;font-weight: bold;">${customer.associeSignataire.fullName}</span>
      </td>
    </tr>
	...
	<tr>
      <th>Traité par</th>
      <td>        
       <span  style="color:black;font-weight: bold;">${customer.customerManager.fullName}</span>
      </td>
    </tr>
	  ...
	  <td align="center">
			...
			<div style="">
				<table id="hor-minimalist-b" width="100%">
					...
					<th scope="col" align="center" width="10%"><span  style="color:blue;font-weight: bold;">Type</span></th>											
					</tr>
					</thead>
					<tbody>
					
						 <c:set var="row" value="0"/>
						 <c:forEach var="item" items="${customer.contracts}" varStatus="loop">
								<c:choose>
	  ...
	  <td align="center">
			...
			<div style="">
				<table id="hor-minimalist-b" width="100%">
					...
					<thead>
					<tr>
					<th scope="col" align="center"><span  style="color:blue;font-weight: bold;">Name </span></th>
					<th scope="col" align="center" width="10%"><span  style="color:blue;font-weight: bold;">Job Title</span></th>									
					<th scope="col" align="center" width="10%"><span  style="color:blue;font-weight: bold;">Phone</span></th>											
					</tr>
					</thead>
					<tbody>
					
						 <c:set var="row" value="0"/>
						 <c:forEach var="item" items="${customer.contacts}" varStatus="loop">
								<c:choose>
									<c:when test='${row % 2 eq 0 }'>
										<tr onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'" >
									</c:when>
								...
								<td align="left" style="border: 0px;border: 1px solid black;">
									...
									<div style="width: 100px;border: 0px;"><span  style="color:purple;" >${item.lastName}&nbsp;${item.firstName}</span></div>			
								
								
								</td>
								<td align="left" style="border: 0px;border: 1px solid black;"><span  style="color:purple;font-weight: bold;">
