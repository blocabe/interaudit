    ...
    function getEventData() {
        ...
        return {
            events : [
               ...
               {"id":2, "start": new Date(year, month, day - 1, 14), "end": new Date(year, month, day - 1, 14, 45),"title":"Dev Meeting"},
               {"id":3, "start": new Date(year, month, day + 1, 17), "end": new Date(year, month, day + 1, 17, 45),"title":"Hair cut"},
               {"id":4, "start": new Date(year, month, day - 1, 8), "end": new Date(year, month, day - 1, 9, 30),"title":"Team breakfast"},
               {"id":5, "start": new Date(year, month, day + 1, 14), "end": new Date(year, month, day + 1, 15,15),"title":"Product showcase"},
