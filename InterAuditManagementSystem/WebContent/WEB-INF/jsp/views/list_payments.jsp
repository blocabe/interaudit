...
<%@ taglib uri="/WEB-INF/struts-tiles.tld" prefix="tiles" %>
	...
	<tiles:put name="content" value="list-payments-content.jsp"/>
</tiles:insert>
...
YAHOO.namespace("example.container");
   ...
   //Define various event handlers for Dialog   
    ...
    YAHOO.example.container.dialog4 = new YAHOO.widget.Dialog("showPaymentHistoryDialog",
                                                                { width : "45em",
                                                                  draggable: true,
                                                                  fixedcenter : true,
                                                                  visible : false,
...
var sEditPaymentHistoryItemUrl = "${ctx}/editPaymentHistoryItemPage.htm";

function editPaymentHistoryItem(invoiceId,invoiceReference){
    var postData = "paymentId="+invoiceId+"&invoiceRef="+invoiceReference;
    var request = YAHOO.util.Connect.asyncRequest('POST', sEditPaymentHistoryItemUrl, callback, postData);
}
</script>
</html>