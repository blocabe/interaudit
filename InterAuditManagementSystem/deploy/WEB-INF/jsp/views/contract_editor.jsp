...
<head>
	...
	<title>Edit contract  ${contract.reference} </title>
	...
	function showInvoiceInfos(id){
	  ...
	  function addPayment()
		...
		function editContract(){
		    ...
		    var url ="${ctx}/editContractPage.htm?contractId=";
...
<div class="nav_alphabet" style="background-color: rgb(248, 246, 233); border: 1px solid  #0066aa; text-align:center; padding-top:1pt; font: bold 12px Verdana, sans-serif;">
        <form name="listForm" action="" method="post" >                 
                        ...
                        <select style="font:10px Verdana, sans-serif;margin-right:10pt;" name="id" id="id" onchange="editContract();">                  
...
<div id="global">
	...
	<tr>
		<td colspan="2" align="center">
				<span  style="color:black;font-weight: bold;">					
						<span  style="color:blue;font-weight: bold;"> ${contract.reference} </span> 
				</span>
		</td>
	</tr>
	...
	<tr>
      ...
      <td>
        <span  style="color:black;font-weight: bold;">${contract.reference}</span>
      </td>
    </tr>
	...
	<tr>
      ...
      <td>
		<span  style="color:black;font-weight: bold;">${contract.customer.companyName}</span>
      </td>
    </tr>
	...
	<tr>
      <th>Début</th>
      <td>
	  <span  style="color:black;font-weight: bold;">${contract.fromDate}</span>
	...
	<tr>
      <th>Fin</th>
      <td>
	 <span  style="color:black;font-weight: bold;">${contract.toDate}</span>
	...
	<tr>
	  ...
	  <c:choose>
			<c:when test='${contract.language eq "EN" }'>													
	...
	<tr>
      <th>Associé</th>
      <td>
        <span  style="color:black;font-weight: bold;">${contract.customer.associeSignataire.fullName}</span>
      </td>
    </tr>
	...
	<tr>
      <th>Manager</th>
      <td>
        <span  style="color:black;font-weight: bold;">${contract.customer.customerManager.fullName}</span>
      </td>
    </tr>
	...
	<tr>
      <th>Type mission</th>
      <td>
        <span  style="color:black;font-weight: bold;">${contract.missionType}</span>
      </td>
    </tr>
	...
	<tr>
      <th>Accord</th>
      <td>
        <span  style="color:black;font-weight: bold;">${contract.agreed}</span>
      </td>
    </tr>
	...
	<tr>
      ...
      <td>	  	
		<div id="editable_cont">
			<div id="addresse" class="editable">${contract.description}</div>			
		</div>				
	  </td>
    </tr>
