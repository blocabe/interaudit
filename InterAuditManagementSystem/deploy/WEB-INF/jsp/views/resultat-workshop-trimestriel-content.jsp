...
<li><a href="${ctx}/showBudgetResultsMensuelsPage.htm">Resultats mensuels</a></li>
<li><a id="current" href="${ctx}/showBudgetResultsTrimestrielsPage.htm">Resultat trimestriels</a></li>
												...
												<table id="div_1" class="ver-zebra" width="100%" cellspacing="0" >
												 <tbody>
													<tr  class="odd">
														...
														<th scope="col"><span style="color:rgb(218,69,37);">Facturé</span></th>
													</tr>
...
--%>
								<table class="ver-zebra" width="100%" cellspacing="0" >
									<tbody>
											...
											<tr>
												<th colspan ="${ fn:length(viewExercise.associeOptions) +1}" align="left">
												<span style="color:purple;">Trimestre 1 [Janvier- Fevrier-Mars]</span></th>
											</tr>
											...
											<tr>
												<th colspan ="${ fn:length(viewExercise.associeOptions) +1}" align="left"><span style="color:purple;">Trimestre 2 [Avril-Mai-Juin]</span></th>
											</tr>
											...
											<tr>
												<th colspan ="${ fn:length(viewExercise.associeOptions) +1}" align="left"><span style="color:purple;">Trimestre 3  [Juillet-Aout-Septembre]</span></th>
											</tr>
											...
											<tr>
												<th colspan ="${ fn:length(viewExercise.associeOptions) +1}" align="left"><span style="color:purple;">Trimestre 4  [Octobre-Novembre-Decembre]</span></th>
											</tr>
								...
								<table class="ver-zebra" width="100%" cellspacing="0" >
									<tbody>
											...
											<tr>
												<th colspan ="${ fn:length(viewExercise.managerOptions) +1}" align="left"><span style="color:purple;">Trimestre 1 [Janvier- Fevrier-Mars]</span></th>
											</tr>
											...
											<tr>
												<th colspan ="${ fn:length(viewExercise.managerOptions) +1}" align="left"><span style="color:purple;">Trimestre 2 [Avril-Mai-Juin]</span></th>
											</tr>
											...
											<tr>
												<th colspan ="${ fn:length(viewExercise.managerOptions) +1}" align="left"><span style="color:purple;" >Trimestre 3  [Juillet-Aout-Septembre]</span></th>
											</tr>
											...
											<tr>
												<th colspan ="${ fn:length(viewExercise.managerOptions) +1}" align="left"><span style="color:purple;">Trimestre 4  [Octobre-Novembre-Decembre]</span></th>
											</tr>
...
<div id="addDialog1" class="yui-pe-content">
	<div class="hd">
        <span id="formTitle2" style="color:#039;">Repartition par associés</span>
    </div>
	<div class="bd">
			<fieldset> 
				<dl>
