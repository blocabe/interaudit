...
<tiles:put name="content" value="task_documents-content.jsp"/>
...
var sEditDocumentUrl = "${ctx}/editTaskDocumentPage.htm";
...
function deleteDocument(id)
  {
    ...
    {
      window.location="${ctx}/deleteTaskDocumentPage.htm?documentId="+id;
    }
  }
</script>
</html>