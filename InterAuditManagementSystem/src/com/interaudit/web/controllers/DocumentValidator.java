 ...
 */
public class DocumentValidator implements
        org.springframework.validation.Validator
{
    @SuppressWarnings("unchecked")
	public boolean supports(Class clazz)
    {
        return clazz.equals(com.interaudit.domain.model.Document.class);
    }
    ...
    {
    	/*
    	com.interaudit.domain.model.Document document = (com.interaudit.domain.model.Document)command;
        if (document == null)
        {
            return;
        }
