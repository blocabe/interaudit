 ...
 */
public class ExerciseValidator implements
        org.springframework.validation.Validator
{
    @SuppressWarnings("unchecked")
	public boolean supports(Class clazz)
    {
        return clazz.equals(com.interaudit.domain.model.Exercise.class);
    }
    ...
    {
    	/*
    	com.interaudit.domain.model.Bank bank = (com.interaudit.domain.model.Bank)command;
        if (bank == null)
        {
            return;
        }
