 ...
 */
public class ExpenseValidator implements
        org.springframework.validation.Validator
{
    @SuppressWarnings("unchecked")
	public boolean supports(Class clazz)
    {
        return clazz.equals(com.interaudit.domain.model.Cost.class);
    }
    ...
    {
    	/*
    	com.interaudit.domain.model.Cost cost = (com.interaudit.domain.model.Cost)command;
        if (cost == null)
        {
            return;
        }
