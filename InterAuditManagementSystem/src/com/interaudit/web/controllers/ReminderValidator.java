 ...
 */
public class ReminderValidator implements
        org.springframework.validation.Validator
{
    @SuppressWarnings("unchecked")
	public boolean supports(Class clazz)
    {
        return clazz.equals(com.interaudit.domain.model.RemindInvoice.class);
    }
    ...
    {
    	/*
    	com.interaudit.domain.model.RemindInvoice remindInvoice = (com.interaudit.domain.model.RemindInvoice)command;
        if (remindInvoice == null)
        {
            return;
        }
