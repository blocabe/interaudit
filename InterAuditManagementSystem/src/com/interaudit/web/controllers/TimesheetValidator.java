 ...
 */
public class TimesheetValidator implements
        org.springframework.validation.Validator
{
    @SuppressWarnings("unchecked")
	public boolean supports(Class clazz)
    {
        return clazz.equals(com.interaudit.domain.model.Timesheet.class);
    }
    ...
    {
    	/*
    	com.interaudit.domain.model.Timesheet timesheet = (com.interaudit.domain.model.Timesheet)command;
        if (timesheet == null)
        {
            return;
        }
