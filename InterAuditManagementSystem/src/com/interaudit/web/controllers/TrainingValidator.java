 ...
 */
public class TrainingValidator implements
        org.springframework.validation.Validator
{
    @SuppressWarnings("unchecked")
	public boolean supports(Class clazz)
    {
        return clazz.equals(com.interaudit.domain.model.Training.class);
    }
    ...
    {
    	/*
    	com.interaudit.domain.model.Training training = (com.interaudit.domain.model.Training)command;
        if (training == null)
        {
            return;
        }
